        ...
        <div class="row">
            <nav class="navbar navbar-expand-lg bg-light">
                <div class="container-fluid">
                    <a class="navbar-brand" href="#"><span class="iconify" data-icon="vaadin:stock" data-width="40" data-height="40" style="color: blue"></span></a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                            ...
                            <a class="nav-link" href="exibir.php">Estoque</a>
                        </div>
                    </div>
                </div>
            </nav>
                    ...
                    <div class="card mb-2 bg-light text-dark"">
                        ...
                        <div class="card-body">
                            <form action="salvar_dados.php" method="POST">
                                ...
                                <label>Código:</label>
                                <input type="number" name="codigo" class="form-control form-control-sm"><br>
                                <label>Estoque:</label>
                                <input type="number" name="estoque" class="form-control form-control-sm"><br>
                                <label>Preço (R$):</label>
                                <input type="number" name="preco" step="0.01" class="form-control form-control-sm"><br>
